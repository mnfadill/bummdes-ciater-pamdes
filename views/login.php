                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>BumDes</b> Desa Ciater</h1>
                                    </div>
                                    ...
                                    <form class="user" method="POST" action="<?= base_url('auth/login') ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="username"
                                                placeholder="Masukan username" autocomplete="off" required="required"
                                                autofocus>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <hr>
                                        <center>
                                            <small>Distributed By <a href="https://blogbugabagi.blogspot.com"
                                                    target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></small>
                                        </center>
                                    </form>
                                </div>
                            </div>
