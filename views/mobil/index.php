                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('mobil/tambah') ?>"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" name="no_polisi" id="no_polisi" required="required"
                                                    placeholder="ketik" autocomplete="off" class="form-control">
                                            </div>
                                            <div class="form-group col-6">
                                    ...
                                    <table class="table table-bordered" id="dataTable" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('mobil/ubah/' . $mobil->id) ?>"
                                                        class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                                    <a href="<?= base_url('mobil/detail/' . $mobil->id) ?>"
                                                        class="btn btn-sm btn-warning"><i class="fa fa-eye"></i>
                                                        Detail</a>
                                                    <a href="<?= base_url('mobil/hapus/' . $mobil->id) ?>"
