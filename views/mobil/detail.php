                        ...
                        <div class="col-sm-8">
                            <div class="card shadow">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary">Detail Pembayaran
                                        <!-- <?= $mobil->nama ?> -->
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="<?= base_url('uploads/' . $mobil->gambar) ?>"
                                                alt="<?= $mobil->nama ?>" class="img-thumbnail mb-4">
                                        </div>
                                        <div class="col-md-6">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    <td>Golongan</td>
                                                    <td>:</td>
                                                    <td><b> Golongan <?= $mobil->jumlah_kursi ?> </b></td>
                                                </tr>
                                                <tr>
                                                    <td>Periode</td>
                                                    <td>:</td>
                                                    <td><b>Periode <?= $mobil->tahun_beli ?></b></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <a href="<?= base_url('mobil') ?>" class="btn btn-sm btn-secondary"><i
