                        ...
                        <div class="col-md-6">
                            <div class="card shadow">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-primary"><?= $judul ?> - <?= $pemesan->nama ?>
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="<?= base_url('uploads/' . $pemesan->foto) ?>"
                                                alt="<?= $pemesan->nama ?>" class="img-thumbnail mb-4">
                                        </div>
                                        <div class="col-md-8">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><b><?= $pemesan->nominal_pembayaran ?></b></td>
                                                </tr>
                                                <tr>
                                                    <td>Jenis Kelamin</td>
                                                    <td>:</td>
                                                    <td><b><?= $pemesan->jenis_kelamin == 'L' ? 'Laki laki' : 'Perempuan' ?></b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Alamat</td>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <a href="<?= base_url('pemesan/ubah/' . $pemesan->id) ?>"
                                                class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                            <a href="<?= base_url('pemesan/hapus/' . $pemesan->id) ?>"
                                                class="btn btn-sm btn-danger"
                                                onclick="return confirm('apakah anda yakin?')"><i
                                                    class="fa fa-trash"></i> Hapus</a>
                                            <a href="<?= base_url('pemesan') ?>" class="btn btn-sm btn-secondary"><i
