                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('pemesan/proses_ubah/' . $pemesan->id) ?>"
                                        enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="nama">Nama pemesan</label>
                                            <input type="text" value="<?= $pemesan->nama ?>" name="nama" id="nama"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                                                <option value="L"
                                                    <?= $pemesan->jenis_kelamin == 'L' ? 'selected' : '' ?>>Laki laki
                                                </option>
                                                <option value="P"
                                                    <?= $pemesan->jenis_kelamin == 'P' ? 'selected' : '' ?>>Perempuan
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="nominal" id="nominal" rows="3" class="form-control"
                                                placeholder="ketik"><?= $pemesan->nominal_pembayaran ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="alamat">Alamat Pemesan</label>
                                            <textarea name="alamat" id="alamat" rows="3" class="form-control"
                                                placeholder="ketik"><?= $pemesan->alamat ?></textarea>
                                        </div>
