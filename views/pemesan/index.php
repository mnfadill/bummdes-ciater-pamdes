                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?= base_url('pemesan/tambah') ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nominal" id="nominal" required="required"
                                                placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
